	...
	<table class = "table table-bordered table-stripped table-condensed" align = "center">
		<tr>
            ...
            try
            {
                ...
                <td>
                    <a href="update.jsp?id=<%=result.getString("id") %>"><button type="button" class="edit">Edit</button>
                    <a href="delete.jsp?id=<%=result.getString("id") %>"><button type="button" class="delete">Delete</button>
                </td>
